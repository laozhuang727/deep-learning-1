...
def get_embed(input_data, vocab_size, embed_dim):
    ...
    with tf.variable_scope("embedding"):
        ...
        embedding = tf.Variable(tf.random_uniform([vocab_size, embed_dim], -1, 1, name="embedded"))
        # input: batch_size * time_step * embedding_feature
        embedded_input = tf.nn.embedding_lookup(embedding, input_data, name="embedded_input")
...
with train_graph.as_default():
    ...
    logits, final_state = build_nn(cell, rnn_size, input_text, vocab_size,embed_dim=400)
